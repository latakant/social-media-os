"""MemoryService — persists and retrieves post records and analysis reports.

Pure service: SQLite read/write. No LLM calls, no reasoning.
All callers go through this interface — no direct DB access elsewhere.
"""
